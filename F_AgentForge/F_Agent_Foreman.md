...
atende pelo menos 70% do dominio necessario? Se sim, recomende-o ao inves de
criar um novo.

Regra de criacao sob demanda: crie agente novo apenas quando a lacuna for real,
recorrente ou claramente reutilizavel, e nenhum agente atual cobrir pelo menos
70% do dominio. Se a lacuna for pontual, resolva com prompt, checklist,
template ou delegacao para agentes existentes.
...
4. Identifique agentes existentes relevantes na .codex/:
   ...
   Para cada um, estime cobertura: cobre 70% ou mais do dominio? Se sim, nao
   crie agente novo; recomende usar ou evoluir o existente.
...
7. **Nunca crie agente quando um existente cobre 70% ou mais do dominio.**
   Evolua o agente existente ou use composicao de agentes antes de aumentar o
   arsenal.

8. **Sempre sugira onde o agente entra no pipeline.**
   Diga "entre o passo 6 e o 7 do AGENTS.md" ou "em paralelo ao @D".

9. **Se o pedido for vago, questione antes de criar.**
